...
import { Button, H1, View, Circle, Stack, ScrollView, Card, Spinner, H2, Paragraph, XStack, YStack } from "tamagui";
...
export default function One() {
  ...
  const query = useQuery({queryKey: ["authored_recipes"], queryFn: getRecipesFeed});
