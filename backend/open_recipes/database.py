...
recipe_x_tag = sqlalchemy.Table(
    "recipe_x_tag", metadata_obj, autoload_with=get_engine()
)
recipe_tag = sqlalchemy.Table("recipe_tag", metadata_obj, autoload_with=get_engine())
recipe_ingredients = sqlalchemy.Table(
    "recipe_ingredients", metadata_obj, autoload_with=get_engine()
)
user_x_ingredient = sqlalchemy.Table(
    "user_x_ingredient", metadata_obj, autoload_with=get_engine()
)
